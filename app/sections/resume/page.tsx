...
const Resume = () => {
    ...
    const resumeDownloadLink = "https://drive.google.com/uc?export=download&id=1awJcO-VjbjT09tCXSXUqygF6Jy4h8upN";
    ...
    return (
        <Card className="bg-zinc-800 border-none rounded-2xl min-h-full pl-2 md:pl-4 pr-2 md:pr-4 max-h-[550px] md:max-h-[550px] w-full">
            ...
            <CardContent className="text-white text-xs md:text-md overflow-y-auto custom-scrollbar flex flex-col items-center justify-center py-6 md:py-12 space-y-4 md:space-y-6">
                ...
                <div className="flex flex-col md:flex-row gap-3 md:gap-4 w-full px-4 md:w-auto">
                    <Button 
                        className="bg-blue-600 hover:bg-blue-700 text-white flex items-center justify-center gap-2 w-full md:w-48 text-sm md:text-base py-2 md:py-3 rounded-lg"
                        asChild
                    >
                    ...
                    <Button 
                        className="bg-green-600 hover:bg-green-700 text-white flex items-center justify-center gap-2 w-full md:w-48 text-sm md:text-base py-2 md:py-3 rounded-lg"
                        asChild
                    >
